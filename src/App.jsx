...
import ArtWorksEditTest from "./pages/Admin/ArtWorks/ArtworksEditTest";
      ...
      <BrowserRouter>
        ...
        <div className="container">
          <Routes>
            ...
            />
            <Route
              path="/admin/expositions"
              element={auth && <ExpositionDashboard />}
            />
            <Route
              path="/admin/artworks"
              element={auth && <ArtWorksDashboard />}
            />
            <Route
              path="/admin/artworks/register"
              element={auth && <ArtWorksRegister />}
            />
            <Route
              path="/admin/artworks/:id"
              element={auth && <ArtWorksEditTest />}
            />
            <Route
              path="/admin/dashboard"
              element={auth && <AdminDashboard />}
            />
            <Route
              path="/admin/timeline"
              element={auth && <TimeLineDashboard />}
            />
            <Route
              path="/admin/artists"
              element={auth && <ArtistsDashboard />}
            />
